...
public class ReadDeviceToCloudMessages {
  ...
  private static final String eventHubsCompatibleEndpoint = "sb://ihsuprodsnres018dednamespace.servicebus.windows.net/";

  // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
  private static final String eventHubsCompatiblePath = "iothub-ehub-labsolarra-244713-6d4fcd8fa9";

  // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
  private static final String iotHubSasKey = "XpjdpIRkE3CDobHFjOenKC2iEXFFSCgoBf4/siiVN2k=";
