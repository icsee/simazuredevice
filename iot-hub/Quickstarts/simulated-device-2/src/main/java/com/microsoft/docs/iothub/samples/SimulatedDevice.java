...
public class SimulatedDevice {
  ...
  private static String connString = "HostName=labsolarrasp.azure-devices.net;DeviceId=raspberrylabsolar;SharedAccessKey=bXngGOxasFhighprQZnug33xU7AkMhllpmSl/pV5dQQ=";
  ...
  // Print the acknowledgement received from IoT Hub for the method acknowledgement sent hola
  ...
  protected static class DirectMethodCallback implements DeviceMethodCallback
  {
    private void setTelemetryInterval(int interval)
    {
      ...
      telemetryInterval = interval * 3000;
    }
  ...
  private static class MessageSender implements Runnable {
    public void run() {
      try {
        ...
        double latitud= 4.583730555;
        double longitud=-74.0913538;
        while (true) {
          // Simulate telemetry.
